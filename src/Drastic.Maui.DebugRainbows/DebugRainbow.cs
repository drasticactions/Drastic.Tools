// <copyright file="DebugRainbow.cs" company="Drastic Actions">
...
namespace Drastic.Maui.DebugRainbows
{
    public static class DebugRainbow
    {
        ...
        public static readonly BindableProperty MajorGridLineColorProperty = BindableProperty.CreateAttached("MajorGridLineColor", typeof(Color), typeof(Page), Color.FromArgb("#ef1a11"));
        ...
        public static readonly BindableProperty GridLineColorProperty = BindableProperty.CreateAttached("GridLineColor", typeof(Color), typeof(Page), Color.FromArgb("#ef1a11"));
